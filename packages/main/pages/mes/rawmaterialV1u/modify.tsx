...
import {MesRawMaterialInput, MesRawMaterialStock} from '../../../../mes'
import moment from 'moment'
import {MesRawMaterialStockModify} from '../../../../mes/src/container/RawMaterial/MesRawMaterialStockModify'
  ...
  return (
    <div style={{display: 'flex', }}>
      ...
      <div style={{paddingBottom: 40}}>
        <ProfileHeader/>
        <MesRawMaterialStockModify page={page} keyword={keyword} option={option}/>
      </div>
    </div>
  );
}
