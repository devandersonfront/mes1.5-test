  ...
  const changeRow = (tmpRow: any, key?: string) => {
    ...
    tmpData = tmpRows?.map((v, i) => {
      ...
      return {
        ...
        seq: i+1,
        code: childData.code,
        type: TransferCodeToValue(childData?.type, v.bom.type === 0 ? "rawmaterial" : v.bom.type === 1 ? "submaterial" : "product"),
        tab: v.bom.type,
        type_name: TransferCodeToValue(childData?.type, v.bom.type === 0 ? "rawmaterial" : v.bom.type === 1 ? "submaterial" : "product"),
