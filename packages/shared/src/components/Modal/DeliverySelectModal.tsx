...
const DeliverySelectModal = ({column, row, onRowChange}: IProps) => {
      ...
      <Modal isOpen={isOpen} style={{
        ...
        <div style={{
          ...
          <div style={{ height: 52, display: 'flex', alignItems: 'flex-end'}}>
            ...
            >
              <p style={{color: '#717C90', fontSize: 14}}>취소</p>
            </div>
            <div
              onClick={() => {
                setIsOpen(false)
            ...
            >
              <p style={{color: '#0D0D0D', fontSize: 14, fontWeight: 'bold'}}>선택 완료</p>
            </div>
          </div>
        </div>
      </Modal>
