...
const optionList = ['공장명', '담당자명']

const FactorySearchModal = ({column, row, onRowChange}: IProps) => {
  ...
  const [searchList, setSearchList] = useState<any[]>([
    {factory: '드랑금속', address:'인천시 연수구 송도미래로125 송도타워 123동 11-10호', user_id:'차지훈', appointment: '실장', telephone: '02)777-1235'}
  ])
      ...
      <Modal isOpen={isOpen} style={{
        ...
        <div style={{
          ...
          <div style={{padding: '0 16px 0 16px', width: 1776}}>
            <ExcelTable
              headerList={searchModalList.factory}
              row={searchList ?? []}
              setRow={() => {}}
              width={1746}
              rowHeight={32}
