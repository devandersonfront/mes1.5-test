...
const BASIC_MENUS: IMenuType[] = [
  ...
  // {title: '기계 기준정보', url: '/mes/basic/machine?page=1'},
  {title: '기계 기준정보', url: '/mes/basic/machineV1u'},
  {title: '제품 등록 관리', url: '/mes/basic/product?page=1'},
  // {title: '원자재 기준정보', url: '/mes/basic/rawmaterial?page=1'},
...
const MES_MENUS: IMenuType[] = [
  ...
  },
  {
    title: '원자재 관리', url: '',
    subMenu: [
      {title: '원자재 입고 관리', url: '/mes/rawmaterialV1u/input'},
      {title: '원자재 재고 관리', url: '/mes/rawmaterialV1u/stock'},
    ]
  },
  {
    title: '원자재 관리', url: '',
