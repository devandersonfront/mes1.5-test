...
export const searchModalList: any = {
  ...
  InputLotReadonlyInfo: [
    ...
    {key: 'current', name: 'LOT 재고량', formatter: LineBorderContainer, textAlign: 'center', placeholder:"-"},
    {key: 'amount', name: '생산량', formatter: LineBorderContainer, textAlign: 'center', placeholder:"-"},
  ...
  InputList: [
    ...
    {key: 'real_disturbance', name: '소요량', formatter: LineBorderContainer, textAlign: 'center',placeholder: "-"},
    {key: 'disturbance', name: '생산량', formatter: LineBorderContainer, textAlign: 'center',placeholder: "-"},
  ...
  workRegister: [
    ...
    {key: 'bom', name: '투입 자재', formatter: InputMaterialListModal, textAlign: 'center', modalType:true},
