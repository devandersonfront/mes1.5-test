...
export const PmsTitles = (customTarget?: string , companyTitles?: string) => {
  const pmsDefault = {
    ...
    pressStats: toMenu(titles.pressStats, '', [ '_prodStats','_prodTotalStats', '_capaStats', '_errorStats', '_powerStats', '_idleStats', '_workStats' ]),
    _prodStats: toMenu(titles._prodStats, '/pms/v2/analysis/output'),
    _prodTotalStats: toMenu(titles._prodTotalStats, '/pms/v2/analysis/totaloutput'),
