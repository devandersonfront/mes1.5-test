...
export const columnlist: any = {
  ...
  process: [
    {key: 'name', editor: TextEditor, formatter: SearchModalTest, placeholder:"공정명 입력"},
  ],
  machine:[
  ...
  device: [
    {key: 'mfrName', name: '장치 제조사', editor: TextEditor, placeholder:"제조사 입력"},
    {key: 'name', name: '장치 이름', editor: TextEditor, placeholder:"이름 입력"},
