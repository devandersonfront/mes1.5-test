...
export const columnlist: any = {
  ...
  outsourcingOrder:(basicRow?, setBasicRow?,) =>( [
    ...
    {key: 'due_date', name: '입고 날짜', formatter:CalendarBox, placeholder: '-'},
  ...
  outsourcingOrderList: [
    ...
    {key: 'input', name: '투입 자재', formatter:InputMaterialListModal, readonly:true, type:'basic', action:'register'},
