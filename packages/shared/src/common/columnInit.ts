...
export const columnlist: any = {
  ...
  rawinV1u: [
    ...
    {key: 'width', name:'가로(COLI 폭)', formatter: UnitContainer, unitData: 'mm', placeholder: '0' },
  ...
  rawstockV1u: [
    ...
    {key: 'width', name:'가로(COLI 폭)', formatter: UnitContainer, unitData: 'mm', placeholder: '0', width: 118 },
  ...
  operationListV2: [
    ...
    {key: 'input', name: '투입 자재', formatter: InputMaterialInfoModal, width: 118},
  ...
  operationModifyV2: [
    ...
    {key:"customer", name:"거래처", width: 118},
    {key:"model", name:"모델", width: 118 },
    {key:"code", name:"CODE", formatter: ProductSearchModal, width: 118},
    {key:"product", name:"품명", width: 118},
    {key:"type", name:"품목 종류", width: 118},
    {key:"unit", name:"단위", width: 118},
    {key:"process", name:"생산 공정", width: 118},
