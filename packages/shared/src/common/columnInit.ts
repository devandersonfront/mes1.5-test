...
export const columnlist: any = {
  ...
  outsourcingOrder:(basicRow?, setBasicRow?,) =>( [
    {key: 'product_name', name: '품명', formatter:SearchModalTest, type: 'outsourceProduct', noSelect:true, placeholder: '-'},
    ...
    {key: 'user', name: '발주자', formatter:SearchModalTest, type: 'user', noSelect:true, placeholder: '-'},
    {key: 'customer', name: '거래처', formatter:PlaceholderBox, placeholder: '-'},
    {key: 'order_date', name: '발주 날짜', formatter:CalendarBox, placeholder: '-'},
    {key: 'due_date', name: '입고 희망일', formatter:CalendarBox, placeholder: '-'},
    {key: 'input', name: '투입 자재', formatter:InputMaterialListModal, textAlign: 'center', state:"outsourcing", type:'basic', action:'register'},
    {key: 'good_quantity', name: '수량', formatter:PlaceholderBox, editor:TextEditor, placeholder: '-'},
  ]),
  outsourcingOrderList: [
    {key: 'identification', name: '고유번호', formatter:PlaceholderBox, type: 'product', placeholder: '-'},
    ...
    {key: 'current', name: '남은 발주량', formatter:PlaceholderBox, placeholder: '-'},
    ...
    {key: 'due_date', name: '입고 희망일', formatter:CalendarBox, readonly:true, placeholder: '-'},
    // {key: 'worker', name: '발주자', formatter:PlaceholderBox, type: 'user', placeholder: '-'},
    {key: 'customer', name: '거래처', formatter:PlaceholderBox, placeholder: '-'},
    {key: 'bom', name: '투입 자재', formatter:LotInputInfoModal, width: 118, type: 'readonly', state:"outsourcing" ,unprintable : true},
  ],
