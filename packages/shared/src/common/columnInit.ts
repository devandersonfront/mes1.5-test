...
export const columnlist: any = {
  ...
  substockV1u: [
    ...
    {key: 'date', name: '입고일', width: 118, headerRenderer: HeaderFilter,
      options:[{status:'none', name:"입고일"},{status:'ASC', name:"오름차순"},{status:'DESC', name:"내림차순"}],
      selectList: [{status:'none', name:"입고일"},{status:'ASC', name:"오름차순"},{status:'DESC', name:"내림차순"}],},
  ...
  operationListV2: [
    ...
    {key:"identification", name:"지시 고유 번호", width: 118   },
    {key:"date", name:"지시 날짜", width: 118, headerRenderer: HeaderFilter,
      options:[{status: 'none', name:"지시 날짜"}, {status: 'ASC', name:"오름차순"},{status: 'DESC', name:"내림차순"}],
      selectList:[{status: 'none', name:"지시 날짜"}, {status: 'ASC', name:"오름차순"},{status: 'DESC', name:"내림차순"}],
    },
    {key:"deadline", name:"작업 기한", width: 118, headerRenderer: HeaderFilter,
      options:[{status: 'none', name:"작업 기한"}, {status: 'ASC', name:"오름차순"},{status: 'DESC', name:"내림차순"}],
      selectList:[{status: 'none', name:"작업 기한"}, {status: 'ASC', name:"오름차순"},{status: 'DESC', name:"내림차순"}],
    },
    {key:"customer_id", name:"거래처", width: 118},
    {key:"cm_id", name:"모델", width: 118 },
  ...
  orderList: [
    ...
    {key:"date", name:"수주 날짜", width: 118, headerRenderer: HeaderFilter,
      options:[{status: 'none', name:"수주 날짜"}, {status: 'ASC', name:"오름차순"},{status: 'DESC', name:"내림차순"}],
      selectList:[{status: 'none', name:"수주 날짜"}, {status: 'ASC', name:"오름차순"},{status: 'DESC', name:"내림차순"}],
    },
    {key:"deadline", name:"납품 기한", width: 118,
      headerRenderer: HeaderFilter,
      options: [{status: 'none', name:"납품 기한"}, {status: 'ASC', name: "오름차순"},{status: 'DESC', name:"내림차순"}],
      selectList: [{status: 'none', name:"납품 기한"}, {status: 'ASC', name:"오름차순"},{status: 'DESC', name:"내림차순"}],
    },
    {key:"customer_id", name:"거래처", width: 118, formatter: PlaceholderBox, placeholder: '자동입력' },
    {key:"cm_id", name:"모델", width: 118, formatter: PlaceholderBox, placeholder: '자동입력' },
  ...
  deliveryList: [
    ...
    {key:"date", name:"납품 날짜", width: 118, headerRenderer: HeaderFilter,
      options:[{status: 'none', name:"납품 날짜"}, {status: 'ASC', name:"오름차순"},{status: 'DESC', name:"내림차순"}],
      selectList:[{status: 'none', name:"납품 날짜"}, {status: 'ASC', name:"오름차순"},{status: 'DESC', name:"내림차순"}], },
