...
export const columnlist: any = {
  member: [
    {key: 'name', editor: TextEditor, formatter: PlaceholderBox, placeholder:"성명 입력"},
    {key: 'appointment', editor: TextEditor, formatter: PlaceholderBox, placeholder:"직책 입력"},
    {key: 'telephone', editor: TextEditor, formatter: PlaceholderBox, placeholder:"전화번호 입력"},
    {key: 'email', editor: TextEditor, formatter: PlaceholderBox, placeholder:"이메일 입력"},
    {key: 'authority', formatter: AuthoritySearchModal, placeholder:"권한 선택"},
    // {key: 'authority', formatter: DropDownEditor, selectList: []},
    {key: 'tmpId', editor: TextEditor, formatter: PlaceholderBox, placeholder:"아이디 입력"},
    {key: 'password', editor: TextEditor, formatter: PlaceholderBox, placeholder:"비밀번호 입력"},
    {key: 'password-confirm', editor: TextEditor, formatter: PlaceholderBox, placeholder:"비밀번호 확인"},
  ...
  model: [
    {key: 'customer_id', formatter: SearchModalTest, type: 'customer', placeholder:"-" },
    {key: 'crn', formatter: PlaceholderBox, placeholder:"사업자 번호 입력" },
  ...
  machineV2:[ //기계기준정보
    ...
    {key: 'mfrCode', name: '제조 번호(필수)', editor: TextEditor, width: 118, placeholder:"제조 번호 입력"},
  ...
  product: [
    ...
    {key: 'depth', editor: TextEditor, formatter: UnitContainer, type:"number", unitData: 'mm', toFix: 2},
    {key: 'width', editor: TextEditor, formatter: UnitContainer, type:"number", unitData: 'mm'},
    {key: 'height', editor: TextEditor, formatter: UnitContainer, type:"number", unitData: 'mm'},
    {key: 'type', formatter: DropDownEditor, selectList: [
        {pk: 'COIL', name: 'COIL'},
        {pk: 'SHEET', name: 'SHEET'}
      ]},
    {key: 'unitWeight', editor: TextEditor, formatter: UnitContainer, type:"number", unitData: 'kg', searchType: 'rawin'},
  ...
  productV1u: [
    ...
    {key: 'standard_uph', name: '기준 UPH', editor: TextEditor, type:"number", formatter: PlaceholderBox, placeholder: 0},
  ...
  rawmaterial: [
    ...
    {key: 'depth', name: '두께', editor: TextEditor, formatter: UnitContainer, type:"number", unitData: 'T',  placeholder:"0"},
    {key: 'width', name: '가로(COIL 폭)', editor: TextEditor, formatter: UnitContainer, type:"number", unitData: 'mm',  placeholder:"0"},
    {key: 'height', name: '세로(Feeder)', editor: TextEditor, formatter: UnitContainer, type:"number", unitData: 'mm',  placeholder:"0"},
  ...
  rawinV1u: [
    ...
    {key: 'amount', name:'입고량', editor: TextEditor,formatter: UnitContainer, unitData: 'kg', searchType: 'rawin', placeholder: '0', type:"number"},
  ...
  rawstockV1u: [
    ...
    {key: 'date', name: '입고일', width: 118, headerRenderer: HeaderFilter,
      options:[{status:0, name:"입고일"},{status:1, name:"오름차순"},{status:2, name:"내림차순"}],
  ...
  operationIdentificationRegisterV2: [
    {key:"contract_id", name:"수주 번호", formatter: SearchModalTest, type: 'order', placeholder: '검색', disableType:"true", width: 118},
  ...
  operationListV2: [
    ...
    {key:"identification", name:"지시 고유 번호", width: 118   },
    {key:"date", name:"지시 날짜", width: 118 },
    {key:"deadline", name:"작업 기한", width: 118, headerRenderer: HeaderFilter,
      options:[{status: 0, name:"작업 기한"}, {status: 1, name:"오름차순"},{status: 2, name:"내림차순"}],
      selectList:[{status: 0, name:"작업 기한"}, {status: 1, name:"오름차순"},{status: 2, name:"내림차순"}],
    },
    {key:"customer_id", name:"거래처", width: 118},
    {key:"cm_id", name:"모델", width: 118 },
  ...
  recordListV2: [
    ...
    {key:"end", name:"작업 종료 일시", width: 118, headerRenderer: HeaderFilter,
      options:[{status: 0, name:"작업 종료 일시"}, {status: 1, name:"오름차순"},{status: 2, name:"내림차순"}],
      selectList:[{status: 0, name:"작업 종료 일시"}, {status: 1, name:"오름차순"},{status: 2, name:"내림차순"}],
    },
  ...
  orderList: [
    ...
    {key:"date", name:"수주 날짜", width: 118, headerRenderer: HeaderFilter,
      options:[{status: 0, name:"수주 날짜"}, {status: 1, name:"오름차순"},{status: 2, name:"내림차순"}],
  ...
  deliveryList: [
    ...
    {key:"type", name:"품목 종류", width: 118   },
    {key:"unit", name:"단위", width: 118   },
    {key:"date", name:"납품 날짜", width: 118, headerRenderer: HeaderFilter,
      options:[{status: 0, name:"납품 날짜"}, {status: 1, name:"오름차순"},{status: 2, name:"내림차순"}],
      selectList:[{status: 0, name:"납품 날짜"}, {status: 1, name:"오름차순"},{status: 2, name:"내림차순"}], },
