...
export const columnlist: any = {
  ...
  machineV2:[
    ...
    {key: 'weldingType', name: '용접 타입', formatter: DropDownEditor, selectList: [
        {pk: 0, name: "선택없음"},
        {pk: 1, name: "아르곤"},
        {pk: 2, name: "스팟"},
        {pk: 3, name: "통합"},
      ], width: 118},
    {key: 'madeAt', name: '제조 연월일', editor: CalendarBox, width: 118},
    ...
    {key: 'factory', name: '공장명', width: 118, formatter: SearchModalTest, type: 'factory',},
  ...
  device: [
    ...
    {key: 'madeAt', name: '제조 연월일', editor: CalendarBox},
  ...
  productV1u: [
    ...
    {key: 'cm_id', name: '모델', formatter: SearchModalTest, type: 'model'},
    ...
    {key: 'bom', name: 'BOM', formatter: BomInfoModal},
    {key: 'process', name: '생산 공정', formatter: DropDownEditor, selectList: [
        {pk: 'EA', name: 'EA'},
      ]},
    {key: 'mold', name: '금형', formatter: MoldInfoModal},
    {key: 'machine', name: '기계', formatter: MachineInfoModal},
    {key: 'uph', name: '기준 UPH', editor: TextEditor, formatter: PlaceholderBox, placeholder: 0},
  ],
  // rawmaterial: [
  //   {key: 'customer_id',},
  //   {key: 'cm_id', },
  ...
  rawmaterial: [
    ...
    {key: 'width', name: '가로(COLE 폭)', editor: TextEditor, formatter: UnitContainer, unitData: 'mm'},
    ...
    {key: 'customer', name: '거래처', formatter: SearchModalTest, type: 'customer' },
    {key: 'useDate', name: '사용기준일', editor: TextEditor, formatter: UnitContainer, unitData: '일'},
  ],
  submaterial: [
    ...
    {key: 'customer', name: '거래처', editor: TextEditor, formatter: SearchModalTest, type: 'customer'},
  ],
  mold: [
    {key: 'customer_id', },
    {key: 'cm_id', },
  ...
  moldV2: [
    {key: 'code', name: 'CODE', formatter: PlaceholderBox, placeholder: 'CODE 입력' },
    {key: 'name', name: '금형명',formatter: PlaceholderBox, placeholder: '금형명 입력'},
    {key: 'cavity', name: '캐비티',formatter: PlaceholderBox, placeholder: '0'},
    ...
    {key: 'product', name: '생산품목', formatter: InfoModal, type: 'productInfo', summaryType: 'mold'},
  ...
  rawinV1u: [
    {key: 'code',name:'원자재 CODE', formatter: ProductSearchModal, searchType: 'rawin', frozen: true, placeholder: '원자재 CODE'},
    {key: 'name', name:'원자재 품명', frozen: true, formatter: PlaceholderBox, placeholder:'자동 입력'},
    {key: 'texture', name:'원자재 재질', formatter: PlaceholderBox, placeholder:'자동 입력'},
    ...
    {key: 'usedate', name:'사용 기준일', editor: TextEditor,formatter: UnitContainer, unitData: '일', placeholder: '자동 입력' },
    ...
    {key: 'number', name:'원자재 LOT 번호', editor: TextEditor, formatter: PlaceholderBox, placeholder: 'LOT 입력'},
  ],

  rawstockV1u: [
    {key: 'elapsedDay', name: '경과일', formatter: UseDateCell, width: 118},
    {key: 'code',name:'원자재 CODE', formatter: PlaceholderBox, placeholder: '원자재 CODE', width: 118},
    ...
    {key: 'amount',name: '입고량', formatter: UnitContainer, unitData: 'kg', searchType: 'rawin', width: 118},
    {key: 'date', name: '입고일', width: 118},
    {key: 'number', name: '원자재 LOT 번호', width: 118},
    ...
    {key: 'customer', name: '거래처', width: 118},
    {key: 'useDate', name: '사용 기준일', formatter: UnitContainer, unitData: '일', width: 118},
  ],
  ...
  rawstockModify: [
    ...
    {key: 'customer', name: '거래처', width: 118},
    {key: 'useDate', name: '사용 기준일', formatter: UnitContainer, unitData: '일', width: 118},
    {key: 'amount',name: '입고량', editor: TextEditor, formatter: UnitContainer, unitData: 'kg', searchType: 'rawin', width: 118},
    {key: 'date', name: '입고일', formatter: CalendarBox, width: 118},
    {key: 'number', name: '원자재 LOT 번호', editor: TextEditor, width: 118},
  ],

  subinV1u: [
    {key: 'code',name:'부자재 CODE', formatter: ProductSearchModal, searchType: 'rawin', frozen: true, placeholder: '부자재 CODE'},
    ...
    {key: 'date', name:'입고일', formatter: CalendarBox},
    {key: 'number', name:'부자재 LOT 번호', editor: TextEditor, formatter: PlaceholderBox, placeholder: 'LOT 입력'},
  ],

  substockV1u: [
    {key: 'elapsedDay', name: '경과일', formatter: UseDateCell, width: 118},
    {key: 'code',name:'부자재 CODE', formatter: PlaceholderBox, placeholder: '부자재 CODE', width: 118},
    ...
    {key: 'customer', name:'거래처', formatter: UnitContainer, unitData: 'mm', placeholder: '0', width: 118},
    {key: 'amount',name: '입고량', formatter: UnitContainer, unitData: 'kg', searchType: 'rawin', width: 118},
    {key: 'date', name: '입고일', width: 118},
    {key: 'number', name: '부자재 LOT 번호', width: 118},
    {key: 'current', name: 'LOT 재고량', formatter: UnitContainer, unitData: 'kg', searchType: 'rawin',width: 118},
    {key: 'exhaustion', formatter: DropDownEditor, headerRenderer: HeaderFilter, width: 118,
      options:[{status:0, name:"재고 현황"},{status:1, name:"사용 가능"}],
      selectList: [
  ...
  substockModify: [
    {key: 'code',name:'부자재 CODE', formatter: PlaceholderBox, placeholder: '원자재 CODE', width: 118},
    {key: 'name', name:'부자재 품명', formatter: PlaceholderBox, placeholder:'자동 입력', width: 118},
    {key: 'unit', name:'재질 종류',formatter: PlaceholderBox, placeholder:'자동 입력', width: 118 },
    {key: 'customer', name:'거래처', formatter: PlaceholderBox, placeholder: '0', width: 118},
    {key: 'amount',name: '입고량', editor: TextEditor, formatter: UnitContainer, unitData: 'kg', searchType: 'rawin', width: 118},
    {key: 'date', name: '입고일', formatter: CalendarBox, width: 118},
    {key: 'number', name: '부자재 LOT 번호', editor: TextEditor, width: 118},
  ],
  ...
  operationRegisterV2: [
    {key:"order_num", name:"수주 번호", formatter: SearchModalTest, type: 'order', placeholder: '검색'   },
    {key:"start_date", name:"지시 날짜", formatter: CalendarBox, },
    {key:"limit_date", name:"작업 기한", formatter: CalendarBox,},
    ...
    {key:"product", name:"품명", formatter: PlaceholderBox, placeholder: '자동입력', type: 'autoInput'},
    ...
    {key: 'bom', name: '자재 선택', formatter: BomRegisterModal, width: 118},
  ],
  operationListV2: [
    {key:"status", name:"상태", width: 118},
    {key:"order_num", name:"수주 번호", width: 118   },
    {key:"operation_num", name:"지시 고유 번호", width: 118   },
    {key:"start_date", name:"지시 날짜", width: 118 },
    {key:"limit_date", name:"작업 기한", width: 118 },
    {key:"customer", name:"거래처", width: 118},
    {key:"model", name:"모델", width: 118 },
    {key:"code", name:"CODE", width: 118 },
    {key:"product", name:"품명", width: 118},
    {key:"type", name:"품목 종류", width: 118},
    {key:"unit", name:"단위", width: 118},
    {key:"process", name:"생산 공정", width: 118},
    {key:"goal", name:"목표 생산량", width: 118},
    {key: 'input', name: '투입 자재', formatter: InputMaterialInfoModal, width: 118, type: 'readonly'},
    {key: 'register', name: '작업 일보 등록', formatter: WorkRegisterModal, width: 118},
    {key: 'history', name: '작업 이력', formatter: WorkListModal, width: 118, modalInitData: BomRegisterInit },
    {key: 'total', name: '총 카운터', width: 118 },
    {key: 'totalCurrent', name: '총 양품 수량', width: 118 },
    {key: 'totalBad', name: '총 불량 수량', width: 118, formatter: DefectInfoModal},
    {key: 'relativeProcess', name: '연관 작업', formatter: RelationWork, width: 118},
    {key: 'finish', name: '작업완료 처리', formatter: FinishButton, width: 118},
  ],
  operationModifyV2: [
    {key:"order_num", name:"수주 번호", width: 118},
    {key:"operation_num", name:"지시 고유 번호", width: 118   },
    {key:"start_date", name:"지시 날짜", formatter: CalendarBox, width: 118 },
    {key:"limit_date", name:"작업 기한", formatter: CalendarBox, width: 118},
    {key:"customer", name:"거래처", width: 118},
    {key:"model", name:"모델", width: 118 },
    {key:"code", name:"CODE", width: 118},
    {key:"product", name:"품명", width: 118},
  ...
  recordListV2: [
    ...
    {key:"unit", name:"단위", width: 118},
    {key:"process", name:"생산 공정", width: 118},
    {key:"lot", name:"LOT 번호", width: 118},
    {key:"worker", name:"작업자", width: 118},
    {key:"start", name:"작업 시작 일시", width: 118},
    {key:"end", name:"작업 종료 일시", width: 118},
    {key:"pause", name:"일시 정지 시간", formatter: PauseInfoModal, type: 'default', width: 118},
    {key:"good", name:"양품 수량", width: 118},
    {key:"pool", name:"불량 수량", formatter: DefectInfoModal, width: 118},
    {key:"uph", name:"UPH", width: 118},
    {key: 'bom', name: '투입 자재', formatter: InputMaterialInfoModal, width: 118, type: 'readonly'},
    {key: 'mold', name: '금형', formatter: MoldListModal, width: 118, modalInitData: BomRegisterInit},
    {key: 'machine', name: '기걔', formatter: MachineListModal, width: 118, modalInitData: BomRegisterInit},
  ],
  finishListV2: [
    {key:"status", name:"상태", formatter: FinishCancelButton, width: 118},
    {key:"order_num", name:"수주 번호", width: 118},
    {key:"operation_num", name:"지시 고유 번호", width: 118   },
    {key:"operation_date", name:"지시 날짜", width: 118   },
    {key:"limit_date", name:"작업 기한", width: 118   },
    {key:"customer", name:"거래처", width: 118   },
    {key:"model", name:"모델", width: 118   },
    {key:"code", name:"CODE", width: 118},
    ...
    {key:"process", name:"생산 공정", width: 118},
    {key:"goal", name:"목표 생산량", width: 118},
    {key: 'bom', name: '투입 자재', formatter: InputMaterialInfoModal, width: 118, modalInitData: BomRegisterInit},
    {key: 'record', name: '작업 이력', formatter: WorkListModal, width: 118, modalInitData: BomRegisterInit},
    {key:"total_count", name:"총 카운터", width: 118},
    {key:"total_good", name:"총 양품 수량", width: 118},
    {key:"total_poor", name:"총 불량 수량", width: 118, formatter: DefectInfoModal},
  ...
  stockV2: [
    ...
    {key:"model", name:"모델", width: 118},
    {key:"code", name:"CODE", width: 118   },
    {key:"material_name", name:"품명", width: 118   },
    {key:"type", name:"품목 종류", width: 118   },
    {key:"unit", name:"단위", width: 118   },
    {key: 'bom', name: 'BOM', formatter: InputMaterialInfoModal, width: 118, modalInitData: BomRegisterInit},
    {key: 'lot', name: 'LOT별 재고', formatter: LotInfoModal, width: 118, modalInitData: BomRegisterInit, type: 'readonly'},
    {key:"stock", name:"재고량", width: 118},
  ],
  orderRegister: [
    {key:"order_date", name:"수주 날짜", formatter: CalendarBox, width: 118},
    {key:"limit_date", name:"납품 기한", formatter: CalendarBox, width: 118},
    {key:"customer", name:"거래처", width: 118, formatter: PlaceholderBox, placeholder: '자동입력' },
    {key:"model", name:"모델", width: 118, formatter: PlaceholderBox },
    {key:"code", name:"CODE", width: 118, formatter: SearchModalTest, type: 'product' },
    {key:"name", name:"품명", width: 118, formatter: PlaceholderBox },
    {key:"type", name:"품목 종류", width: 118, formatter: PlaceholderBox   },
    {key:"unit", name:"단위", width: 118, formatter: PlaceholderBox },
    {key:"order_stock", name:"수주량", width: 118, formatter: PlaceholderBox },
  ],
  orderList: [
    {key:"order_number", name:"수주 번호", width: 118},
    {key:"order_date", name:"수주 날짜", width: 118},
    {key:"limit_date", name:"납품 기한", width: 118},
    {key:"customer", name:"거래처", width: 118 },
    {key:"model", name:"모델", width: 118 },
    {key:"code", name:"CODE", width: 118 },
    {key:"name", name:"품명", width: 118   },
    {key:"type", name:"품목 종류", width: 118   },
    {key:"unit", name:"단위", width: 118   },
    {key:"order_stock", name:"수주량", width: 118   },
    {key:"operation_num", name:"지시 고유 번호", width: 118, formatter: OperationInfoModal},
    {key:"delivery_stock", name:"납품 수량", width: 118, formatter: DeliveryInfoModal },
    {key:"delivery_register", name:"납품 등록", width: 118, formatter: OrderRegisterButton   },
  ],
  orderModify: [
    {key:"order_number", name:"수주 번호", width: 118},
    {key:"order_date", name:"수주 날짜", formatter: CalendarBox, width: 118},
    ...
    {key:"order_stock", name:"수주량", width: 118   },
    {key:"operation_num", name:"지시 고유 번호", width: 118   },
    {key:"delivery_stock", name:"납품 수량", width: 118   },
  ],
  deliveryRegister: [
    {key:"order_number", name:"수주 번호", width: 118, formatter: SearchModalTest, type: 'order'},
    {key:"customer", name:"거래처", width: 118, formatter: PlaceholderBox, placeholder: '자동입력' },
    {key:"model", name:"모델", width: 118, formatter: PlaceholderBox, placeholder: '자동입력' },
    {key:"code", name:"CODE", width: 118, formatter: SearchModalTest, type: 'product' },
    ...
    {key:"lot", name:"LOT 선택", width: 118, formatter: LotInfoModal   },
    {key:"order_stock", name:"총 납품 수량", width: 118, formatter: PlaceholderBox, placeholder: '0'   },
  ],
  deliveryList: [
    {key:"delivery_number", name:"납품 번호", width: 118},
    {key:"order_number", name:"수주 번호", width: 118},
    {key:"customer", name:"거래처", width: 118 },
    {key:"model", name:"모델", width: 118 },
    {key:"code", name:"CODE", width: 118,},
    ...
    {key:"type", name:"품목 종류", width: 118   },
    {key:"unit", name:"단위", width: 118   },
    {key:"order_stock", name:"납품 날짜", width: 118   },
    {key:"delivery_stock", name:"총 납품 수량", width: 118   },
    {key:"lot", name:"LOT별 납품 수량", width: 118   },
  ],
  deliveryModify: [
    {key:"order_number", name:"수주 번호", width: 118, formatter: SearchModalTest, type: 'order'},
    {key:"customer", name:"거래처", width: 118 },
    ...
    {key:"type", name:"품목 종류", width: 118   },
    {key:"unit", name:"단위", width: 118   },
    {key:"order_stock", name:"납품 날짜", width: 118, formatter:CalendarBox},
    {key:"lot", name:"LOT 선택", width: 118   },
    {key:"delivery_stock", name:"총 납품 수량", width: 118   },
  ],
