...
export const columnlist: any = {
  ...
  aiProductState:[
    {key: 'state', frozen:true, name: '상태',  type: 'machineInfo', formatter: StatusComponent, summaryType: 'product_no_cavity', width: 118,},
    {key: 'machine_name', frozen:true, name: '기계 이름',  type: 'machineInfo', formatter:PlaceholderBox, summaryType: 'product_no_cavity', width: 118,},
    {key: 'machine_type', frozen:true, name: '기계 종류',  type: 'machineInfo', formatter:PlaceholderBox, summaryType: 'product_no_cavity', width: 118,},
    {key: 'osd_id', frozen:true, name: '지시 고유 번호',  type: 'machineInfo', formatter:PlaceholderBox, summaryType: 'product_no_cavity', width: 118,},
    // {key: 'deadline', frozen:true, name: '작업 기한', headerRenderer: HeaderToggle, formatter:PlaceholderBox, width:118},
    {key: 'customer', frozen:true, name: '거래처',  type: 'machineInfo', formatter:PlaceholderBox, summaryType: 'product_no_cavity', width: 118,},
    {key: 'model', frozen:true, name: '모델',  type: 'machineInfo', formatter:PlaceholderBox, summaryType: 'product_no_cavity', width: 118,},
    {key: 'code', frozen:true, name: 'CODE',  type: 'machineInfo', formatter:PlaceholderBox, summaryType: 'product_no_cavity', width: 118,},
    {key: 'name', frozen:true, name: '품명',  type: 'machineInfo', formatter:PlaceholderBox, summaryType: 'product_no_cavity', width: 118,},
    {key: 'process', name: '생산 공정',  type: 'machineInfo', formatter:PlaceholderBox, summaryType: 'product_no_cavity', width: 118,},
    {key: 'foresee_model', name: '예측 모델',  type: 'machineInfo', formatter:PlaceholderBox, summaryType: 'product_no_cavity', width: 118,},
    {key: 'foresee_code', name: '예측 CODE',  type: 'machineInfo', formatter:PlaceholderBox, summaryType: 'product_no_cavity', width: 118,},
    {key: 'foresee_name', name: '예측 품명',  type: 'machineInfo', formatter:PlaceholderBox, summaryType: 'product_no_cavity', width: 118,},
    {key: 'goal', name: '목표 생산량',  type: 'machineInfo', formatter:PlaceholderBox, summaryType: 'product_no_cavity', width: 118,},
    {key: 'total_counter', name: '총 카운터',  type: 'machineInfo', formatter:PlaceholderBox, summaryType: 'product_no_cavity', width: 118,},
    {key: 'progress', name: '달성률', formatter: CommonProgressBar, type: 'machineInfo', summaryType: 'product_no_cavity', width: 300,},
  ]
}
