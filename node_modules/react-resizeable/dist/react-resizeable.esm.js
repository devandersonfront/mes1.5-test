import { useState, useRef, useEffect, useCallback, Children, isValidElement, createElement, cloneElement, forwardRef } from 'react';
...
var Parent = /*#__PURE__*/styled.div( /*#__PURE__*/_templateObject(), function (_ref) {
...
var baseResizeStyle = function baseResizeStyle(resizeDir) {
  return css(_templateObject2(), resizeDir);
};
...
var resizeStyles = function resizeStyles(_ref3) {
  ...
  return resizeDir === 'both' || resizeDir === 'vertical' ? css(_templateObject3(), baseResizeStyle(resizeDir)) : baseResizeStyle(resizeDir);
};

var StyledChild = /*#__PURE__*/styled.div( /*#__PURE__*/_templateObject4(), function (_ref4) {
...
var Resizeable = function Resizeable(_ref) {
  ...
  var _React$useState = useState(generateRandomString()),
      resizeId = _React$useState[0];

  var parent = useRef(null);
  var minWidth = useRef(0);
  var medianRootWidth = useRef(0);
  var totalMinWidths = useRef(0);
  var resizeWidthDiff = useRef(0);
  useEffect(function () {
  ...
  var onResize = useCallback(function (_temp) {
  ...
  useEffect(function () {
    ...
    var resizeableChildren = (_React$Children$map = Children.map(children, function (child, idx) {
...
var Child = /*#__PURE__*/forwardRef(function (_ref, ref) {
  var children = _ref.children,
      resize = _ref.resize,
      props = _objectWithoutPropertiesLoose(_ref, ["children", "resize"]);

  return createElement(StyledChild, Object.assign({
    ref: ref
  }, resize, props), children);
});

export { Child, Resizeable };
//# sourceMappingURL=react-resizeable.esm.js.map
